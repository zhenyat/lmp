...
class Admin::PositionsControllerTest < ActionController::TestCase
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post :create, position: { business_id: @position.business_id, name: @position.name, title: @position.title }
    end
  ...
  test "should update position" do
    patch :update, id: @position, position: { business_id: @position.business_id, name: @position.name, title: @position.title }
    assert_redirected_to admin_position_path(assigns(:position))
  end
